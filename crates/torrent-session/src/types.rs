...
pub struct TorrentConfig {
    ...
    pub encryption_mode: torrent_wire::mse::EncryptionMode,
    ...
    pub peer_dscp: u8,
    /// Number of semaphore permits for the per-peer request pipeline.
...
impl Default for TorrentStats {
    fn default() -> Self {
        Self {
            ...
            // Identity
            info_hashes: torrent_core::InfoHashes::v1_only(torrent_core::Id20::from([0u8; 20])),
            name: String::new(),
...
pub(crate) enum PeerCommand {
    ...
    SendHashRequest(torrent_core::HashRequest),
...
pub(crate) enum TorrentCommand {
    ...
    FilePriorities {
        reply: oneshot::Sender<Vec<torrent_core::FilePriority>>,
    },
    ForceReannounce,
    TrackerList {
    ...
    Scrape {
        reply: oneshot::Sender<Option<(String, torrent_tracker::ScrapeInfo)>>,
    },
...
mod tests {
    ...
    fn torrent_stats_default_values() {
        ...
        assert_eq!(
            stats.info_hashes,
            torrent_core::InfoHashes::v1_only(torrent_core::Id20::from([0u8; 20]))
        );

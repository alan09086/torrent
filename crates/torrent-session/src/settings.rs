...
impl Settings {
    pub(crate) fn to_dht_config(&self) -> torrent_dht::DhtConfig {
        let default = torrent_dht::DhtConfig::default();
    ...
    pub(crate) fn to_dht_config_v6(&self) -> torrent_dht::DhtConfig {
        let default = torrent_dht::DhtConfig::default_v6();
        let mut bootstrap = self.dht_saved_nodes.clone();
        bootstrap.extend(default.bootstrap_nodes.iter().cloned());
        torrent_dht::DhtConfig {
            bootstrap_nodes: bootstrap,
    ...
    pub(crate) fn to_nat_config(&self) -> torrent_nat::NatConfig {
        torrent_nat::NatConfig {
    ...
    pub(crate) fn to_utp_config(&self, port: u16) -> torrent_utp::UtpConfig {
        torrent_utp::UtpConfig {
    ...
    pub(crate) fn to_utp_config_v6(&self, port: u16) -> torrent_utp::UtpConfig {
        torrent_utp::UtpConfig {

...
[![Tests](https://img.shields.io/badge/tests-1145-brightgreen)](#-testing)
[![Clippy](https://img.shields.io/badge/clippy-zero%20warnings-brightgreen)](#-testing)
[![Version](https://img.shields.io/badge/version-0.51.0-blue)](#-versioning)
...
- 🎛️ **87-field runtime config** — unified `Settings` struct with presets, JSON serialization, and live updates
- 🧩 **Extension plugin system** — trait-based BEP 10 extension interface for custom protocol extensions
- 📊 **1145 tests, zero clippy warnings**
...
| `ferrite-session` | Full session orchestration — see [Session Features](#-session-features) below | 485 |
...
The `ferrite-session` crate (485 tests) includes:
...
| **Management** | Unified Settings (87 fields, runtime updates), alerts/events system, queue management (auto-manage), smart banning + parole, IP filtering (.dat parser) |
...
| 9: Swarm Intelligence | M43–M46 | Choking algorithms, piece picker, mixed-mode, peer turnover | 🔨 M45 Done |

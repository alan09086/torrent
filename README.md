...
| `ferrite-session` | Session manager, peer tasks, torrent actor, BEP 6/14, seeding, persistence, selective download, bandwidth limiting, alerts, queue management, uTP integration, NAT port mapping | 199 |
...
| `ferrite` | Public facade: full API + ClientBuilder + prelude + unified error | 22 |

**Total: 534 tests, zero clippy warnings.**
